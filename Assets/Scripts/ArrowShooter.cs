...
public class ArrowShooter : MonoBehaviour {
    ...
    private static Vector3 ARROW_SPAWN_VELOCITY = new Vector3(0, 0, 50);
    ...
    private void FixedUpdate()
    {
        if (Input.GetButtonDown("PrimaryFire"))
        {
            ...
            arrow.GetComponent<Rigidbody>().AddRelativeForce(ARROW_SPAWN_VELOCITY, ForceMode.VelocityChange);
        }
    }
}